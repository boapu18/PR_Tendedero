...
function AdminSettings() {
    ...
    const onSubmit = async (data) => {
        const payload = Object.entries(data).map(([name, value]) => ({
            name,
            value,
        }));
                ...
                <>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-3 row">
                            <div className="col">
                                <label className="col-form-label fw-bold">
                                    Habilitar Enlace a Formulario Externo
                                </label>
                                <div className="form-text">
                                    Al habilitar esta opción se va a mostrar el enlace al formulario
                                    externo a los usuarios cuando registren una denuncia
                                    exitosamente.
                                </div>
                            </div>
                        ...
                        <div className="mb-3 row">
                            <div className="col">
                                <label className="col-form-label fw-bold">
                                    Enlace al Formulario Externo
                                </label>
                                <div className="form-text">
                                    El enlace que coloque en este campo se mostrará al usuario al
                                    registrar una denuncia exitosamente. El enlace solo se va a
                                    mostrar si la opción 'Habilitar Enlace a Formulario Externo'
                                    está habilitada.
                                </div>
                            </div>
                            <div className="col">
